    ...
    representarInfoCircuito(contenido) {
        ...
        if (mainInfo) {
            ...
            if (!destino) {
                ...
                h3.textContent = "Información del circuito"; 
            ...
            destino.querySelectorAll("*:not(h3)").forEach(el => el.remove()); 
            destino.insertAdjacentHTML("beforeend", mainInfo.innerHTML);
...
class CargadorSVG {
    constructor(selectorInput, selectorContenedor) {
        ...
        if (!contenedor) {
            ...
            const h3 = document.createElement("h3"); 
            h3.textContent = "Altimetría del circuito (SVG)"; 
    ...
    insertarSVG(contenidoTexto) {
        ...
        this.contenedor.querySelectorAll("svg").forEach(svg => svg.remove());
